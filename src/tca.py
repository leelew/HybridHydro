# NOTE: The calculation of triple collocation is copy from 
#       https://github.com/hectornieto/model_evaluation. 
#       Please contact lilu83@mail.sysu.edu.cn if this code 

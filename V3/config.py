...
def parse_args():
    ...
    # args for preprocess
    parser.add_argument('--raw_data_path', type=str, default='SMAP_L4/')
    parser.add_argument('--begin_train_date', type=str, default='2015-05-31')
    parser.add_argument('--end_train_date', type=str, default='2017-12-31')
    parser.add_argument('--begin_test_date',type=str, default='2018-01-01')
    parser.add_argument('--end_test_date', type=str, default='2018-12-31')
    ...
    parser.add_argument('--h_w', type=int, default=28) # from 112 to 28 
